...
function Navbar() {
  ...
  return (
    <div className="flex flex-row justify-end w-full px-[2rem] items-center py-[1rem] bg-transparent fixed max-w-[100vw] gap-[1rem] slowEase duration-[800ms] transition-all z-[30]">
      <div className="flex flex-row items-center h-[3.5rem]">
        <div
          className={`h-full overflow-hidden transition-all duration-[800ms] ease-slowEase flex flex-row gap-[1rem]
            ${
              active
        ...
        >
          <div className="flex flex-row gap-[1rem] h-full items-center">
            <Button
              text="Login"
